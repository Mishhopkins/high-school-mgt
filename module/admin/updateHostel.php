...
if(isset($_GET['updatehostelId'])) {
    $_SESSION['updatehostelId'] = $_GET['updatehostelId'];

    $query = mysqli_query($link, "SELECT * FROM hostels WHERE hostels_name='$_SESSION[updatehostelId]'");
...
if(isset($_POST['submit'])) {
    ...
    $hostels_name = $_POST['hostels_name'];
    ...
    if(mysqli_num_rows($query) > 0) {
        ...
        $statusMsg = "Teacher is already assigned to a class!";
    } else {
        $ret = mysqli_query($link, "UPDATE hostels SET hostels_name='$hostels_name', master_id='$teacher_id' WHERE hostels_name='$_SESSION[updatehostelId]'");
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Edit Hostel</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="hostel_name" name="hostels_name" value="<?php echo $rowi['hostels_name'];?>" required class="form-control">
                                            </div>
                                        </div>

                                        <div class="col-6">
                                                    <div class="form-group">
                                                    <label for="availability" class="control-label mb-1">Set Hostel as :</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <button type="submit" name="submit" class="btn btn-success">Edit Hostel</button>
                                            </div>
                                    </div>
                               </form>
