...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES["file"]) && !empty($_FILES["file"]["name"])) {
        ...
        if (move_uploaded_file($tempname, $folder)) {
            ...
            $sql = "INSERT INTO teachers (department, file, id, name, password, phone, email, sex, dob, hiredate, address, salary, sessionid) VALUES ('$department_id', '$filename', '$teaId', '$teaName', '$teaPassword', '$teaPhone', '$teaEmail', '$teaGender', '$teaDOB', '$teaHireDate', '$teaAddress', '$teaSalary', '$session_id')";
            ...
            if ($success) {
                ...
                $sql = "INSERT INTO users (userid, password, usertype) VALUES ('$teaId', '$teaPassword', 'teacher')";
                $success = mysqli_query($link, $sql);
                ...
                if ($success) {
                    ...
                    $statusMsg = "An error occurred while adding the teacher to the users table.";
                }
            } else {
                $alertStyle = "alert alert-danger";
                $statusMsg = "An error occurred while adding the student to the teachers table.";
            }
        } else {
            $alertStyle = "alert alert-danger";
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="teaName" name="teacherName" type="text" class="form-control cc-exp" value="" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Enter Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="teaId" name="teacherId" type="text" class="form-control cc-exp"  Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Enter Id">
                                                    </div>
                                                </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="teaPassword" name="teacherPassword" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Enter Password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="teaPhone" name="teacherPhone" type="text" class="form-control cc-exp" value="" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Enter Phone Number">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="teaEmail" name="teacherEmail" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Enter Password">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="teaDOB" name="teacherDOB" type="date" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Enter DOB">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="teaAddress" name="teacherAddress" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Enter Address">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="teaSalary" name="teacherSalary" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Enter Salary">
                                                    </div>
                                                </div>
                                             </div>
                                             ...
                                             <div class="row">
                                                ...
                                                <button type="submit" name="submit" class="btn btn-success">Add New Teacher</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
function generateID() {
    ...
    // You can replace this with the logic to fetch the latest teacher id. from your database.
    const latestID = "te-2023-0000"; // Example: Get the latest teacher id. from your database
    ...
    document.getElementById("teaId").value = newID;
}
</script>
