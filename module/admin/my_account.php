            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6">
                        <div class="card-box text-center bg-white" style="border-radius: 20px; padding: 10px; border: 10px solid black;">
                            <?php
                            $sql = "SELECT * FROM admin WHERE id='$check';";
                            $res = mysqli_query($link, $sql);
                            while ($row = mysqli_fetch_array($res)) {
                            ?>
                                <img src="../images/admin-icn.png" style="width: 100px; height: 100px; border-radius: 50%;">
                                <div class="text-centre mt-1">
                                    <p class="text-dark mt-1 m-0"><strong>Full Name:</strong> <?php echo $row['name']; ?> </p>
                                    <p class="text-dark mt-1 m-0"><strong>Admin Number:</strong> <?php echo $row['id']; ?> </p>
                                    <p class="text-dark mt-1 m-0"><strong>Admin Phone:</strong> <?php echo $row['phone']; ?></p>
                                    <p class="text-dark mt-1 m-0"><strong>Admin Email:</strong> <?php echo $row['email']; ?></p>
