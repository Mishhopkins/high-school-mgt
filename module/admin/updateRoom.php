...
if (isset($_GET['updateroomId'])) {
    $_SESSION['updateroomId'] = $_GET['updateroomId'];

    $query = mysqli_query($link, "SELECT * FROM hostelrooms WHERE room_no='$_SESSION[updateroomId]'");
...
if (isset($_POST['submit'])) {
    ...
    // } else {
        ...
        $updateRoomQuery = mysqli_query($link, "UPDATE hostelrooms SET room_no='$roomNo', hostel_id='$hostelId', availability='$availability' WHERE room_no='$_SESSION[updateroomId]'");
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Edit Hostel Rooms</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="room_no" name="room_no" value="<?php echo $rowi['room_no'];?>" required class="form-control">
                                        </div>
                                    </div>
                                </div>
                                  <div class="row">
