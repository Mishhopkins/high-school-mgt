...
if (isset($_GET['updatebedId'])) {
    $_SESSION['updatebedId'] = $_GET['updatebedId'];

    $query = mysqli_query($link, "SELECT * FROM beds WHERE bed_no='$_SESSION[updatebedId]'");
    $rowi = mysqli_fetch_array($query);
} else {
    echo "<script type = \"text/javascript\">
        window.location = (\"addBeds.php\")
    </script>";
}
...
if (isset($_POST['submit'])) {
    ...
    // $query = mysqli_query($link, "SELECT * FROM beds WHERE bed_no='$bed_no' AND room_id='$room_id'");
    
    // if (mysqli_num_rows($query) > 0) {
    //     $alertStyle = "alert alert-danger";
    //     $statusMsg = "Bed already assigned!";
    // } else {
        $ret = mysqli_query($link, "UPDATE beds SET bed_no='$bed_no', room_id='$room_id', availability='$availability' WHERE bed_no='$_SESSION[updatebedId]'");
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Edit Beds</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                       ...
                                       <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="bed_no" name="bed_no" value="<?php echo $rowi['bed_no'];?>" required class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <button type="submit" name="submit" class="btn btn-success">Edit Beds</button>
                                            </div>
                                    </div>
                            </form>
