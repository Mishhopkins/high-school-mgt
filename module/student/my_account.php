        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    // Fetch class name assigned to the student
                    $classQuery = mysqli_query($link, "SELECT classes.class_name
                        FROM students
                    ...
                    $assignmentQuery = mysqli_query($link, "SELECT subjects.subjectName
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless mb-0">
                                ...
                                <tbody>
                                    ...
                                    echo "<tr><td></td><td>{$className}</td></tr>";
