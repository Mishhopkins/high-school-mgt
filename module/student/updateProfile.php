...
$session = mysqli_query($link, "SELECT name, email, phone FROM students WHERE id='$check'");
...
if (isset($_POST['submit'])) {
    ...
    $ret = mysqli_query($link, "UPDATE students SET name='$name', email='$email', phone='$phone' where id='$check'");
...
if (isset($_POST['update_pwd'])) {
    ...
    $checkOldPassword = mysqli_query($link, "SELECT * FROM students WHERE id='$check' AND password='$oldPassword'");
    if (mysqli_num_rows($checkOldPassword) > 0) {
        // Old password is correct, update the password
        if ($newPassword == $confirmPassword) {
            // Update password in students table
            $updatePassword = mysqli_query($link, "UPDATE students SET password='$newPassword' WHERE id='$check'");
            if ($updatePassword) {
                                                    ...
                                                    <div class="card-box text-center bg-white" style="border-radius: 20px; padding: 20px; border: 5px solid black;">
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="text-centre mt-1">
                                                                <p class="text-dark mt-1 m-0"><strong>Student's Name:</strong> <?php echo $row['name']; ?> </p>
                                                                <p class="text-dark mt-1 m-0"><strong>Student's Number:</strong> <?php echo $row['id']; ?> </p>
                                                                <p class="text-dark mt-1 m-0"><strong>Student's Phone:</strong> <?php echo $row['phone']; ?></p>
                                                                <p class="text-dark mt-1 m-0"><strong>Student's Email:</strong> <?php echo $row['email']; ?></p>
                                                                <p class="text-dark mt-1 m-0"><strong>Date Admitted:</strong> <?php echo $row['addmissiondate']; ?></p>
