                    ...
                    <div class="card-body">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="text-right">
                                <button type="submit" name="view_attendance" class="btn btn-primary waves-effect waves-light mt-2"><i class="fa fa-eye"></i> VIEW ATTENDANCE</button>
                            </div>
                        </form>
                        ...
                        <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['view_attendance'])): ?>
                            <!-- Display attendance records here based on $attendance_query -->
                                ...
                                <tbody>
                                    ...
                                    while ($attendance_row = mysqli_fetch_array($attendance_query)) {
                                        echo '<tr>
                                            ...
                                            <td>
                                                <a href="updateAttendance.php?updateAttendId=' . $attendance_row['id'] . '" class="badge badge-success">
                                                    <i class="fas fa-edit"></i> Update
                                                </a>
                                                <a href="deleteAttendance.php?delid=' . $attendance_row['id'] . '" class="badge badge-danger">
