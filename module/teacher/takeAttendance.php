                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Take Attendance</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <div class="text-right">
                                            <button type="submit" name="modify" class="btn btn-success waves-effect waves-light mt-2"><i class="mdi mdi-content-save"></i> MODIFY</button>
                                        </div>
                                        </form>
                                                            ...
                                                            <form action="#" method="post" enctype="multipart/form-data">
                                                                <table id="attendance-data-table" class="table table-hover table-striped table-bordered">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        while ($student_row = mysqli_fetch_array($student_query)) {
                                                                            $present = ''; // Default class
                                                                            if (isset($_POST['attendance']) && in_array($student_row['id'], $_POST['attendance'])) {
                                                                                $present = 'present'; // Change class if the student is present
                                                                            }
                                                                            ...
                                                                            <td>
                                                                                <button type="submit" name="mark_attendance[' . $student_row['id'] . ']" value="present" class="btn btn-success waves-effect waves-light mt-2"><i class="mdi mdi-content-save"></i> PRESENT</button>
                                                                                <button type="submit" name="mark_attendance[' . $student_row['id'] . ']" value="absent" class="btn btn-danger waves-effect waves-light mt-2"><i class="mdi mdi-content-save"></i> ABSENT</button>
                                                                            </td>
                                                                        </tr>';
                                                                ...
                                                                <script>
                                                                    document.addEventListener('DOMContentLoaded', function () {
                                                                        ...
                                                                        function handleButtonClick(status, studentId) {
                                                                            ...
                                                                            // You can also update the status in a hidden input field or store it in another way

                                                                            // Example: Update a hidden input field with the student's status
                                                                            var statusInput = document.querySelector('input[name="attendance[' + studentId + ']"]');
                                                                        ...
                                                                        presentButtons.forEach(function (button) {
                                                                            button.addEventListener('click', function () {
                                                                                ...
                                                                                handleButtonClick('present', studentId);
                                                                            });
                                                                        });
                                                                        ...
                                                                        absentButtons.forEach(function (button) {
                                                                            button.addEventListener('click', function () {
                                                                                var studentId = this.getAttribute('data-student-id');
                                                                                handleButtonClick('absent', studentId);
                                                                            });
                                                                        });
                                                                    });
                                                                </script>
