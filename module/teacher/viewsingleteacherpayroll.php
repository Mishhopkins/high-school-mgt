...
if (isset($_GET['viewPayrollId'])) {
    $payrollId = $_GET['viewPayrollId'];
    $_SESSION['viewPayrollId'] = $payrollId;

    $query = mysqli_query($link, "SELECT * FROM payrolls WHERE payrollno = '$_SESSION[viewPayrollId]'");
